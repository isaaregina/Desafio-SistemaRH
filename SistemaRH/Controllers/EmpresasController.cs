...
namespace SistemaRH.Controllers
{
    public class EmpresasController : Controller
    {
        ...
        {
            ViewBag.Funcionarios = new SelectList(_context.Funcionario, "FuncionarioID", "Nome");
        ...
        public async Task<IActionResult> Create([Bind("EmpresaID,Nome,Cnpj")] Empresa empresa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmpresaID,Nome,Cnpj")] Empresa empresa)
        {
